...
// View Colours page — displays colour records in a table with name, color code, order, and status
    ...
    <>
      <div className="form-wrapper mt-10 mx-5 rounded-xl overflow-auto shadow-2xl">
        ...
        <div className="form-header border border-gray-200 dark:border-gray-700 py-5 px-6 rounded text-white bg-blue-600 dark:bg-blue-400 dark:text-white hover:bg-blue-700 dark:hover:bg-blue-500">
          <div className="flex">
            <h3 className="text-2xl font-bold dark:text-white">View Colors</h3>
        ...
        {/* Colour table — short content columns are center-aligned, text columns are left-aligned */}
          ...
          <table className="w-full mt-2">
            ...
            <tbody className="border-b">
              <tr className="align-middle">
                ...
                <td className="py-3 px-4 text-center">#fffff</td>
                <td className="py-3 px-4 text-center">1</td>
            ...
            <tbody className="border-b">
              <tr className="align-middle">
                ...
                <td className="py-3 px-4 text-center">1</td>
                <td className="py-3 px-4 text-nowrap">Blue</td>

                <td className="py-3 px-4 text-center">#ccccc</td>
                <td className="py-3 px-4 text-center">1</td>
