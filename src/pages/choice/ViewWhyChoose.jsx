...
// View Why Choose Us page — displays records in a table with filter and bulk actions
  ...
  return (
    <>
      <div className="form-wrapper mt-10 mx-5 rounded-xl overflow-auto shadow-2xl">
        ...
        {/* Why Choose Us table — short content columns are center-aligned, text columns are left-aligned */}
